...
public class Json_servicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_traer_json_servicios);
    ...
    private void lladoGET() {
        String url = "https://g61fb640298abd1-foodisgr8.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/servicios/servicios";
